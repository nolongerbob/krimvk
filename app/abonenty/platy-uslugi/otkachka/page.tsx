...
const sectionCardClass = "mb-8 rounded-none border border-slate-200 border-l-4 border-l-blue-600 shadow-none";
const benefitCategoryClass =
  "flex h-full rounded-none border border-slate-200 bg-white p-4";
  ...
  return (
    <div className="flex min-h-[calc(100dvh-4rem)] flex-col bg-slate-50 py-8 md:py-12 pb-14 lg:min-h-[calc(100dvh-4.5rem)]">
      <div className="container max-w-5xl flex-1 px-4">
        ...
        <DashboardCard className="mb-8 rounded-none border border-blue-200 bg-blue-50 shadow-none animate-fade-in animate-delay-100">
          <DashboardCardBody className="p-6 md:p-8">
            <p className="text-center text-base leading-relaxed text-slate-700 md:text-lg">
        ...
        <DashboardCard className={cn(sectionCardClass, "animate-fade-in animate-delay-200")}>
        ...
        <DashboardCard className={cn(sectionCardClass, "animate-fade-in animate-delay-300")}>
          <div className="p-6 pb-4">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-xl font-semibold md:text-2xl">Как заказать услугу?</h2>
            </div>
          </div>
                ...
                <div className="flex-1 space-y-4">
                  ...
                  <div className="flex flex-wrap items-center gap-x-6 gap-y-2">
                    <a
                      ...
                      className="inline-flex items-center gap-2 font-medium text-slate-900 transition-colors hover:text-blue-600"
                    >
        ...
        <DashboardCard
          className={cn(
            sectionCardClass,
            "border-l-gray-400 bg-slate-50/80 animate-fade-in animate-delay-500"
          )}
        >
          <div className="p-6 pb-4">
            <div className="flex items-center gap-3">
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-none bg-slate-200">
        ...
        <div className="animate-fade-in animate-delay-600">
          <DashboardCard className="rounded-none border border-slate-200 bg-white shadow-none">
            <DashboardCardBody className="flex flex-col items-center gap-5 p-6 text-center md:p-8">
              ...
              <div>
                ...
                <p className="text-slate-600">Заявки принимаются круглосуточно</p>
              </div>
