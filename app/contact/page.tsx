    ...
    <div className="flex flex-col">
      <section className="bg-white py-16">
        ...
        <div className="grid w-full grid-cols-1 lg:grid-cols-2 lg:items-stretch">
          <DashboardCard className="flex min-h-[520px] flex-col rounded-none border-x-0 border-t border-b shadow-none hover:translate-y-0 lg:border-r">
            <DashboardCardBody className="flex h-full w-full flex-col px-8 pb-14 pt-14 lg:px-12 lg:pb-16 lg:pt-16">
              <div className="mb-10 flex min-h-[150px] w-full flex-col items-center justify-start gap-3 text-center">
                ...
                <h2 className="text-center text-2xl leading-tight">Прием показаний водомеров ХВС</h2>
                <p className="mx-auto max-w-sm text-center text-base">
              ...
              <div className="mx-auto flex w-full max-w-lg flex-1 flex-col">
                ...
                <div className="mt-auto flex min-h-[132px] flex-col items-center justify-start border-t border-slate-200 pt-6 text-center">
          ...
          <DashboardCard className="flex min-h-[520px] flex-col rounded-none border-x-0 border-t border-b border-red-200 bg-red-50 shadow-none hover:translate-y-0">
            <DashboardCardBody className="flex h-full w-full flex-col px-8 pb-14 pt-14 lg:px-12 lg:pb-16 lg:pt-16">
              <div className="mb-10 flex min-h-[150px] w-full flex-col items-center justify-start gap-3 text-center">
                <IconBadge className="bg-red-100">
                  <AlertTriangle className="h-6 w-6 text-red-600" />
                </IconBadge>
                <h2 className="text-center text-2xl leading-tight">Аварийно-диспетчерская служба</h2>
                <p className="mx-auto max-w-sm text-center text-base">
              ...
              <div className="mx-auto flex w-full max-w-lg flex-1 flex-col">
                ...
                <div className="mt-auto flex min-h-[132px] flex-col items-center justify-center border-t border-red-200 pt-6">
                  <Button
                    asChild
                    className="rounded-none bg-red-600 px-8 py-6 text-base hover:bg-red-700 hover:scale-100 active:scale-100 !rounded-none"
                  >
      ...
      <section className="bg-slate-50 py-16">
        ...
        <div className="grid w-full grid-cols-1 lg:grid-cols-2 lg:items-stretch">
          <DashboardCard className="flex min-h-[520px] flex-col rounded-none border-x-0 border-t border-b bg-white shadow-none hover:translate-y-0 lg:border-r">
            <DashboardCardBody className="flex h-full w-full flex-col px-8 pb-14 pt-14 lg:px-12 lg:pb-16 lg:pt-16">
              <div className="mb-10 flex flex-col items-center gap-3 text-center">
                <IconBadge className="bg-orange-100">
                  <Mail className="h-6 w-6 text-orange-600" />
                </IconBadge>
                <h2 className="text-2xl leading-tight">Контактная информация</h2>
              </div>
              ...
              <div className="mx-auto flex w-full max-w-lg flex-col space-y-6">
                ...
                <div className="flex items-start gap-3 text-left">
                  ...
                  <div>
                    <p className="font-medium text-slate-900">Режим работы офиса</p>
                ...
                <div className="border-t border-slate-200 pt-6">
                  <p className="mb-4 text-center font-medium text-slate-900">Социальные сети</p>
                  <div className="flex flex-wrap items-center justify-center gap-4">
                    <a
                      href="https://vk.com/krimvk"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 rounded-none bg-blue-50 px-4 py-2.5 text-sm font-medium text-blue-700 transition-colors hover:bg-blue-100"
                    >
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 rounded-none bg-sky-50 px-4 py-2.5 text-sm font-medium text-sky-700 transition-colors hover:bg-sky-100"
                    >
                      <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden>
          ...
          <DashboardCard className="flex min-h-[520px] flex-col rounded-none border-x-0 border-t border-b bg-white shadow-none hover:translate-y-0">
            <DashboardCardBody className="flex h-full w-full flex-col px-8 pb-14 pt-14 lg:px-12 lg:pb-16 lg:pt-16">
              <div className="mb-10 flex flex-col items-center gap-3 text-center">
                <IconBadge className="bg-indigo-100">
                  <Building2 className="h-6 w-6 text-indigo-600" />
                </IconBadge>
                <h2 className="text-2xl leading-tight">Реквизиты</h2>
              </div>

              <div className="mx-auto w-full max-w-lg text-left">
                <p className="mb-6 text-base font-medium leading-snug text-slate-900">
