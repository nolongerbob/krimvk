...
export default async function NewsPage() {
  ...
  return (
    <div className={`${sitePageClass} flex min-h-[calc(100dvh-4rem)] flex-col py-12 md:py-14 lg:min-h-[calc(100dvh-4.5rem)]`}>
      <div className="container mx-auto flex flex-1 flex-col px-4">
        ...
        {news.length === 0 ? (
          <div className="flex flex-1 flex-col items-center justify-center py-6 md:py-10">
            <DashboardCard className="w-full max-w-xl rounded-none border bg-white shadow-none">
              <DashboardCardBody className="flex flex-col items-center px-8 py-14 text-center md:px-10 md:py-16">
                <div className="mb-6 flex h-14 w-14 items-center justify-center rounded-none bg-cyan-100">
                  <Newspaper className="h-7 w-7 text-cyan-600" />
                </div>
                <p className="mb-2 text-xl font-semibold text-slate-900">Пока нет новостей</p>
                <p className="mb-8 max-w-sm text-base text-slate-600">
