...
export default async function HomePage() {
  ...
  return (
    <div className="flex flex-col">
      {/* Hero Section */}
      <section className="relative text-gray-900 py-16 md:py-24 overflow-hidden rounded-t-2xl rounded-b-2xl mt-2 px-2 sm:px-4 md:px-6 lg:px-8">
        {/* Background Image */}
      ...
      {/* Quick Actions */}
      <section className="pt-8 pb-12 bg-gray-50 rounded-t-2xl rounded-b-2xl mt-4 px-2 sm:px-4 md:px-6 lg:px-8">
